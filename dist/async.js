...
var funcaoPesada = new Promise(function (resolve, reject) {
  try {
    var execucoes = 0;
...
var promiseParameters = function promiseParameters(login, senha) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      resolve("Logado: ".concat(login));
    }, 3000);
  });
};
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          */
          ...
          promiseParameters('julia', 12346).then(function (result) {
